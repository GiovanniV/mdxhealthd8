...
;
(function(b,a){a.AjaxCommands.prototype.imageDialogSave=function(f,e,c){var d=e.values;if(d.form_type=="background"){b("#slide-backgroundimage").val(d.fid[0]);b("#custom-bg-alt").val(d.attributes.alt);b("#slide-background-preview").find("img").attr("src",d.attributes.src);b("#slide-background-preview").show()}if(d.form_type=="thumbnail"){b("#slide-thumbnail").val(d.fid[0]);b("#custom-thumb-alt").val(d.attributes.alt);b("#slide-thumbnail-preview").find("img").attr("src",d.attributes.src);b("#slide-thumbnail-preview").show()}if(d.form_type=="image"){b("textarea.mdt-imgalt","#md-toolbar").val(d.attributes.alt);b("img.mdt-imgsrc","#md-toolbar").attr("src",d.attributes.src);b("input.mdt-image-fileid","#md-toolbar").val(d.fid[0]);b(".mdt-type-image").trigger("change")}if(d.form_type=="videothumb"){b("#videothumb").attr("src",d.attributes.src)}};a.imageAjaxDialog=function(c){var f=[],e={};f.push("ui-dialog--narrow");e.dialogClass=f.join(" ");e.autoResize=window.matchMedia("(min-width: 600px)").matches;e.width="auto";var d=a.ajax({dialog:e,dialogType:"modal",selector:"#dlg-video",url:a.url("md-slider/image"),progress:{type:"throbber"},submit:{image_object:c}});d.execute()},a.behaviors.MDSliderImage={attach:function(c,d){b(".choose-image",c).click(function(){var e={};e.type="background";e.fid=b(this).next("#slide-backgroundimage").val();e.src=b(this).find("#slide-background-preview").find("img").attr("src");e.alt=b(this).find("#custom-bg-alt").val();a.imageAjaxDialog(e)});b(".choose-thumbnail",c).click(function(){var e={};e.type="thumbnail";e.fid=b("#slide-thumbnail",c).val();e.src=b("#slide-thumbnail-preview",c).find("img").attr("src");e.alt=b("#custom-thumb-alt",c).val();a.imageAjaxDialog(e)});b(".panel-change-videothumb").live("click",function(f){f.preventDefault();var e={};e.type="videothumb";e.fid=-1;a.imageAjaxDialog(e)});b("#change-image").click(function(){var e={};e.type="image";e.fid=-1;a.imageAjaxDialog(e)})},}})(jQuery,Drupal);;
(function(a){a.fn.triggerItemEvent=function(){var c=a(this).data("slidepanel");if(c==null){return}var d=a(this);d.draggable({containment:"parent",stop:function(e,f){var h=Math.round(a(f.helper).position().left),g=Math.round(a(f.helper).position().top);d.data("left",h);d.data("top",g);c.mdSliderToolbar.changePositionValue(h,g)}});d.resizable({handles:"e, s, se",containment:"parent",resize:function(g,h){var f=Math.round(a(h.helper).width()),e=Math.round(a(h.helper).height());d.data("width",f);d.data("height",e);c.mdSliderToolbar.changeSizeValue(f,e)}});if(navigator.appVersion.indexOf("Mac")!=-1){a(document).keyup(function(e){d.data("keySelect","")});a(document).keydown(function(e){d.data("keySelect",e.keyCode)})}d.bind("mousedown",function(j){var k=j.ctrlKey,i=navigator.userAgent.indexOf("Chrome")!=-1,h=navigator.userAgent.indexOf("Firefox")!=-1,g=navigator.userAgent.indexOf("Safari")!=-1;if(navigator.appVersion.indexOf("Mac")!=-1&&d.data("keySelect")!=undefined){var f=d.data("keySelect");if((f==224&&h)||(f==91&&(i||g))){k=true}else{k=false}}if(k){a(this).addClass("ui-selected")}else{if(!a(this).hasClass("ui-selected")){a(this).siblings(".slider-item").removeClass("ui-selected");a(this).addClass("ui-selected")}else{a(this).siblings(".slider-item.ui-selected").removeClass("ui-selected")}}c.triggerChangeSelectItem()});return this};function b(d,c){return d.length<c?b("0"+d,c):d}a.fn.getItemValues=function(){if(a(this).hasClass("slider-item")){var c={width:a(this).data("width"),height:a(this).data("height"),left:a(this).data("left"),top:a(this).data("top"),starttime:a(this).data("starttime")?Math.round(a(this).data("starttime")):0,stoptime:a(this).data("stoptime")?Math.round(a(this).data("stoptime")):0,startani:a(this).data("startani"),stopani:a(this).data("stopani"),opacity:a(this).data("opacity"),mdtclass:a(this).data("mdtclass"),style:a(this).data("style"),zindex:a(this).css("z-index"),type:a(this).data("type"),title:a(this).data("title"),backgroundcolor:(a(this).data("backgroundcolor")==undefined||a(this).data("backgroundcolor")==="")?null:(a(this).data("backgroundcolor")==0?"#000000":a.fixHex(a(this).data("backgroundcolor").toString())),backgroundtransparent:a(this).data("backgroundtransparent"),borderposition:a(this).data("borderposition"),borderwidth:a(this).data("borderwidth"),borderstyle:a(this).data("borderstyle"),bordercolor:(a(this).data("bordercolor")==undefined||a(this).data("bordercolor")==="")?null:(a(this).data("bordercolor")==0?"#000000":a.fixHex(a(this).data("bordercolor").toString())),bordertopleftradius:a(this).data("bordertopleftradius"),bordertoprightradius:a(this).data("bordertoprightradius"),borderbottomrightradius:a(this).data("borderbottomrightradius"),borderbottomleftradius:a(this).data("borderbottomleftradius"),paddingtop:a(this).data("paddingtop"),paddingright:a(this).data("paddingright"),paddingbottom:a(this).data("paddingbottom"),paddingleft:a(this).data("paddingleft"),link:a(this).data("link")};if(a(this).data("type")=="text"){a.extend(c,{fontsize:a(this).data("fontsize"),fontfamily:a(this).data("fontfamily"),fontweight:a(this).data("fontweight"),fontstyle:a(this).data("fontstyle"),textdecoration:a(this).data("textdecoration"),texttransform:a(this).data("texttransform"),textalign:a(this).data("textalign"),color:(a(this).data("color")==undefined||a(this).data("color")==="")?null:(a(this).data("color")==0?"#000000":a.fixHex(a(this).data("color").toString()))})}else{a.extend(c,{fileid:a(this).data("fileid"),thumb:a(this).find("img").attr("src")});if(c.type==="video"){c.displayMode=a(this).data("displayMode")}}return c}return null};a.fn.setItemValues=function(d){if(a(this).hasClass("slider-item")){var c=a(this);a.each(d,function(e,f){c.attr("data-"+e,f)});return true}return null};a.fn.setItemStyle=function(k){if(a(this).hasClass("slider-item")){var j=a(this);var f={};if(k.style){j.addClass(k.style)}if(k.width){f.width=k.width}if(k.height){f.height=k.height}if(k.top){f.top=k.top}if(k.left){f.left=k.left}if(k.opacity){f.opacity=k.opacity/100}if(k.backgroundcolor!=null){var l=k.backgroundcolor;var g=parseInt(k.backgroundtransparent);var h=a.HexToRGB(l);g=g?g:100;var d="rgba("+h.r+","+h.g+","+h.b+","+(g/100)+")";f["background-color"]=d}if(k.bordercolor){f["border-color"]=k.bordercolor}if(k.borderwidth){f["border-width"]=k.borderwidth+"px"}var e="none";if(k.borderposition&&k.borderstyle){var i=k.borderposition,c=k.borderstyle;if(i&1){e=c}else{e="none"}if(i&2){e+=" "+c}else{e+=" none"}if(i&4){e+=" "+c}else{e+=" none"}if(i&8){e+=" "+c}else{e+=" none"}}f["border-style"]=e;if(k.bordertopleftradius){f["border-top-left-radius"]=k.bordertopleftradius+"px"}if(k.bordertoprightradius){f["border-top-right-radius"]=k.bordertoprightradius+"px"}if(k.borderbottomrightradius){f["border-bottom-right-radius"]=k.borderbottomrightradius+"px"}if(k.borderbottomleftradius){f["border-bottom-left-radius"]=k.borderbottomleftradius+"px"}if(k.paddingtop){f["padding-top"]=k.paddingtop+"px"}if(k.paddingright){f["padding-right"]=k.paddingright+"px"}if(k.paddingbottom){f["padding-bottom"]=k.paddingbottom+"px"}if(k.paddingleft){f["padding-left"]=k.paddingleft+"px"}if(k.type=="text"){if(k.fontsize){f["font-size"]=k.fontsize+"px"}if(k.fontfamily){f["font-family"]=k.fontfamily}if(k.fontweight){f["font-weight"]=k.fontweight}if(k.fontstyle){f["font-style"]=k.fontstyle}if(k.textdecoration){f["text-decoration"]=k.textdecoration}if(k.texttransform){f["text-transform"]=k.texttransform}if(k.textalign){f["text-align"]=k.textalign}if(k.color){f.color=k.color}}j.css(f)}return false};a.fn.setItemHtml=function(c){if(a(this).hasClass("slider-item")){if(c.type=="text"){a(this).find("p").html(c.title.replace(/\n/g,"<br />"))}else{a(this).find("img").attr("src",c.thumb)}}return false};a.HexToRGB=function(c){var c=parseInt(((c.toString().indexOf("#")>-1)?c.substring(1):c),16);return{r:c>>16,g:(c&65280)>>8,b:(c&255)}};a.removeMinusSign=function(c){return c.replace(/-/g,"")};a.objectToString=function(c){return JSON.stringify(c)};a.stringToObject=function(c){return jQuery.parseJSON(c)};a.fixHex=function(e){var c=6-e.length;if(c>0){var f=[];for(var d=0;d<c;d++){f.push("0")}f.push(e);e=f.join("")}return e}})(jQuery);;
