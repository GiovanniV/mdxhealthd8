...
/* {# inline_template_start #}<div class="col-sm-6">
	...
	<div class="member-wrap">
		...
		<div class="member-img-wrap">
			<img src="{{ field_avatar }}" alt="{{ title }}" class="img-responsive">
		</div>
...
class __TwigTemplate_aafefc317d406cbc0d1e1abb399615e6a028e6feec30614a930929668121e866 extends Twig_Template
{
