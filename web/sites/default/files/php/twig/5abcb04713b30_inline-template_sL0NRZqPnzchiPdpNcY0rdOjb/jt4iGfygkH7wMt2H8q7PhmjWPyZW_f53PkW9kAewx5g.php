...
class __TwigTemplate_d148a4abc954cab492ca1e6bdc496095cd287ffecc87652a1e8460018c76a9af extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<div class=\"yamlform-form-filter-text-source\">{{ label }}</div>", "{# inline_template_start #}<div class=\"yamlform-form-filter-text-source\">{{ label }}</div>", "");
    }
}
